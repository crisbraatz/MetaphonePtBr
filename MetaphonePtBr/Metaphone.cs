...
{
    /// <summary>
    /// Generates a PT-BR metaphone token from the single PT-BR word provided.
    /// </summary>
    /// <param name="word">A single PT-BR word.</param>
    /// <returns>The generated PT-BR metaphone token.</returns>
