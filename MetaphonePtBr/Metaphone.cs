        ...
        public static string GetMetaphoneToken(this string? value)
        {
            ...
            while (currentIndex < wordWithoutAccents.Length)
            {
                ...
                switch (currentLetter)
                {
                    ...
                    case 'C':
                    case 'Ç':
                        index += C.Convert(currentLetter.Value, nextLetter, firstLetterAfterNext, token);

                        break;
                    case 'G':
                        index += G.Convert(nextLetter, firstLetterAfterNext, token);

                        break;
                    case 'H':
                        index += H.Convert(currentIndex, nextLetter, token);

                        break;
                    case 'L':
                        index += L.Convert(nextLetter, token);
                    ...
                    case 'N':
                        ...
                        break;
                    case 'P':
                        index += P.Convert(nextLetter, token);
                    ...
                    case 'Q':
                        ...
                        break;
                    case 'R':
                        index += R.Convert(previousLetter, nextLetter, token);

                        break;
                    case 'S':
                        index += S.Convert(nextLetter, firstLetterAfterNext, token);

                        break;
                    case 'T':
                        index += T.Convert(nextLetter, token);

                        break;
                    case 'W':
                        index += W.Convert(nextLetter, token);

                        break;
                    case 'X':
                        index += X.Convert(firstLetterBeforePrevious, previousLetter, nextLetter, token);
