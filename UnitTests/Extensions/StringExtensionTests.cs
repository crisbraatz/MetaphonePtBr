...
public class StringExtensionTests
{
    ...
    [Fact]
    public void Should_validate_is_not_null_and_not_empty_and_not_white_space()
    {
    ...
    [InlineData("")]
    [InlineData(" ")]
    public void Should_throw_exception_when_is_null_or_empty_or_white_space(string word)
    {
        _action = word.IsNullOrWhiteSpace;
    ...
    [Fact]
    public void Should_validate_is_single_word()
    {
    ...
    [Fact]
    public void Should_throw_exception_when_is_not_single_word()
    {
    ...
    [Fact]
    public void Should_throw_exception_when_contains_non_letters()
    {
        for (var i = 32; i < 127; i++)
        {
            ...
            _action = ("WORD" + (char)i).IsSingleWord;
