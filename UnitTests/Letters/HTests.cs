...
public class HTests
{
    ...
    public void Should_convert_letter(int currentIndex, char? nextLetter, char? expectedNewLetter, int expectedIndex)
    {
        var token = new StringBuilder();

        var returnedIndex = H.Convert(currentIndex, nextLetter, token);
