...
public class CTests
{
    ...
    public void Should_convert_letter(
        char currentLetter, char? nextLetter, char? firstLetterAfterNext, char? expectedNewLetter, int expectedIndex)
    {
        var token = new StringBuilder();

        var returnedIndex = C.Convert(currentLetter, nextLetter, firstLetterAfterNext, token);
